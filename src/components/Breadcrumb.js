  ...
  return (
    <nav aria-label="breadcrumb">
      <ul className="breadcrumb" >
        ...
        <li>
          <Link href="/" className="text-dark" style={{ color: "darkred",fontWeight:"500", fontFamily:"ProximaNova,sans-serif" }}>HOME</Link>
        </li>
        ...
        {paths.map((path, index) => {
          ...
          return (
            ...
            <li key={index}>
              ...
              <Link href={url} className="text-dark text-uppdercase" style={{ color: "darked",fontWeight:"500" }}>
