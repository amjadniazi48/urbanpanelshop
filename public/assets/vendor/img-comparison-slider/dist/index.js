      ...
      "undefined" != typeof window &&
        ...
        window.customElements.define(
          ...
          class extends h {
            constructor() {
              super(),
                (this.exposure = this.hasAttribute("value") ? Number.parseFloat(this.getAttribute("value")) : 50),
                (this.slideOnHover = !1),
                ...
                (this.onTouchStart = (t) => {
                  ;(this.dragByHandle && !s(this.handleElement, t)) ||
                    ...
                    this.isFocused && (this.enableTransition(), this.slideToPage(this.touchStartPoint)))
                }),
                (this.onTouchMove = (t) => {
            ...
            connectedCallback() {
              this.hasAttribute("tabindex") || (this.tabIndex = 0),
                ...
                this.setExposure(0),
                (this.keyboard =
                  this.hasAttribute("keyboard") && "disabled" === this.getAttribute("keyboard")
                    ? "disabled"
                    : "enabled"),
